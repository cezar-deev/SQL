...
----va_status-------
case 
when a.statusva = '' and a.pre_fitup = '' then 'PREDI' 
when a.pre_fitup = 'AP' and a.statusva = ''  and a.non_execution_status  not like  '%FT%' then 'FUI'   
when a.pre_fitup = 'AP' and a.non_execution_status like '%FT%' and a.statusva = '' then 'REJ' 
when a.pre_fitup = 'AP' and a.non_execution_status like '%FT%' and a.statusva = 'AP' then 'AP' 
when a.pre_fitup = 'AP' and a.non_execution_status  NOT like '%FT%' and a.statusva = 'AP' then 'AP' 
when a.statusva = 'AP' then  'AP' end va_status,

a.va,

case 
when a.pre_fitup = 'AP' and a.statusva = '' then  a.dt_pre_fitup else a.va_data end as va_data,
