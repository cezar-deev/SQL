...
from
    ...
    case when b.rs_status = 'AP' and b.rs_data is null then b.va_data else b.rs_data end rs_data,
    ...
    from
            ...
            ----VS-----
            case when a.statusrs = 'AP' and a.statusvs = '' and a.non_execution_status not LIKE  '%VT%' then 'VT' when
            ...
            a.statusrs = 'AP' and a.statusvs = 'AP' and a.non_execution_status like '%VT%' then 'AP' end vs_data,
            --a.statusvs = 'AP' then 'AP' end as vs_status,
            a.vs,
            ...
            when a.statusrs = 'AP' and a.statusvs = 'AP' and a.non_execution_status like '%VT%' then a.vs_data  
            when a.statusrs = 'AP' and a.statusvs = 'AP' then a.vs_data end as vs_data,
            a.vs_insp,
            ...
            ----US-----
            case 
            when a.statusvs = 'AP' and a.statusus = '' then 'UT' 
            when A.STATUSVS = '' AND A.STATUSUS = 'AL' THEN 'AL' 
            WHEN a.statusvs = 'AP' and a.statusus <> ''  then a.statusus end as us_status,
            a.us,
