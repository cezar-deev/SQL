...
select *
from(select
case when b.df like '%SMP%' then SUBSTRING(b.df FROM POSITION('-SMP',b.df)+1 FOR 9) else null end AS SMP,
b.sub_bloco,
b.modulo,
b.area,
b.folha,
...
where b.cod_junta not like '#%' and  b.cod_junta not like '%S/R%' and b.df like '%SMP%' )c  -- Aqui indiquei selecionei puxar somente SMP--