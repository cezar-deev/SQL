...
where jnt.cod_junta not like '%#%' and (DFB.TIPO_ESTRUTURA='P71-JURONG' or DFB.TIPO_ESTRUTURA is null )) aa


group by

aa.PLATFORM, aa.MANUFACTURER, aa.MODULE, aa.SUB_BLOCK, aa.PIECE, aa.JOINT_CODE, aa.WELDING_MAP, aa.EXECUTION, aa.IFC_DRAWING, aa.IFC_REVIEW,
aa.COMPONENT_1, aa.COMPONENT_2, aa.MATERIAL_TYPE_1, aa.NESTING_PLAN_1, aa.PRODUCT_NO_1, aa.MATERIAL_HEAT_NO_1, aa.CERTIFICATE_NO_1, aa.RIR_1, aa.RIR_DATE_1,
aa.COATING_REPORT_1, aa.RIP_1_DATE, aa.MATERIAL_TYPE_2, aa.NESTING_PLAN_2, aa.PRODUCT_NO_2, aa.MATERIAL_HEAT_NO_2, aa.CERTIFICATE_NO_2, aa.RIR_2, aa.RIR_2_DATE,
aa.COATING_REPORT_2, aa.RIP_2_DATE, aa.INSPECTION_CATEGORY, aa.JOINT_TYPE, aa.LENGHT, aa.THICKNESS_1, aa.THICKNESS_2, aa.FT,aa.RI_VA, aa.DATE_FT, aa.FT_STATUS, aa.WE,
aa.DATE_WE, aa.WE_STATUS, aa.WELDER_NUMBER, aa.IEIS, aa.CONSUMABLE, aa.VT, aa.RI_VS, aa.DATE_VT, aa.VT_STATUS, aa.PL, aa.DATE_PL, aa.PL_STATUS, aa.LENGTH_PL, aa.PL_PERCENT,
aa.MT, aa.RI_PM, aa.DATE_MT, aa.MT_STATUS, aa.LENGTH_MT, aa.MT_PERCENT, aa.RT, aa.DATE_RT, aa.RT_STATUS, aa.LENGTH_RT, aa.RT_PERCENT, aa.UT, aa.RI_US, aa.DATE_UT, aa.UT_STATUS,
aa.LENGTH_UT, aa.UT_PERCENT, aa.DI, aa.DI_STATUS, aa.pi_status, aa.STATUS_JUNTA